# Remap Manifest — mycelium-std-time → std.time
...
|---|---|---|---|---|---|---|
| `std.time` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-std-time/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
